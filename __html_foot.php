        ...
        <div class="e_footer_container">
            <div class="footer_wrapper">
                ...
                <div class="footer_section">
                    <ul>
                        <li class="section_title">
                            ...
                            <a class="border_top e_dropdown noto_regular">
                                關於我們
                                <i class="fas fa-angle-right e_arrow_icon"></i></a>
                    ...
                    <ul>
                        <li class="section_title">
                            <a class="e_dropdown noto_regular">服務<i class="fas fa-angle-right e_arrow_icon"></i></a>
                    ...
                    <ul>
                        <li class="section_title">
                            <a class="e_dropdown noto_regular">政策與規範<i class="fas fa-angle-right e_arrow_icon"></i></a>
                            <ul class="sub_footer ">
