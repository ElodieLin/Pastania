...
<?php include __DIR__. '/__navbar.php' ?>
    <style>
        ...
        .w_product_list_cover {
            width: 100%;
            height: 30vh;
            background: url(img/pages/product_list/short_cover.jpg) center 100%;
    ...
    <section>
        ...
        <div class="container">
            <div class="w_product_list_title">
                ...
                <p class="noto_regular">短麵</p>
                <img class="w_product_list_title_img" src="img/pages/product_list/short_title.svg" alt="">
                <p class="en_font">Short cut</p>
            ...
            <div class="row">
                <div class="w_product_list_wrapper col-md-4 col-6">
                    <div class="w_product_list_bg">
                        <!------------ 此處換商品照片 ------------>
                        <img src="img/product/s/S1_Penne_Lisce_s.png" alt="">
                    </div>
                    <div class="w_product_list_word_bg">
                        <!------------ 此處為商品照片連結 （電腦版）------------>
                        <a href="" class="">
                            <p class="w_noto_light_small    w_product_list_word_center    padding-r">短麵</p>
                            <p class="w_en_font_small    w_product_list_word_center    padding-r">Short cut</p>
                    ...
                    <div class="w_product_list_word_mobil">
                        <!------------ 此處為商品照片連結（手機版） ------------>
                        <a href="">
                            <p class="w_noto_light_small    padding-r">短麵</p>
                            <p class="w_en_font_small    padding-r">Short cut</p>
                        </a>
                    </div>
                </div>
