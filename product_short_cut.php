...
$page_name = 'product_list_short_cut';
...
// 取得分類資料
$c_sql = "SELECT * FROM product_list WHERE parent_sid=1";
...
$t_sql = " SELECT COUNT(1) FROM product_info WHERE productlist_sid=1";
...
$p_sql = sprintf("SELECT * FROM product_info WHERE productlist_sid = 1 LIMIT $starting_limit, $per_page");
