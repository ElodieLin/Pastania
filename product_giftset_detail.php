    ...
    <style>
        ...
        .w_product_giftset_detail_transition {
            transition: all .2s;
        ...
        .w_product_giftset_detail_wrapper_two {
            width: 100%;
            margin: 0 auto;
        }


        .w_product_giftset_detail_wrapper_three {
            width: 90%;
            margin: 0 auto;
        }
        ...
        .w_product_giftset_detail_wrapper_five {
            /* ----------此為寫評價按鈕區域(隱藏中)---------- */
            width: 90%;
            margin: 0 auto;
            text-align: center;
        ...
        .w_product_giftset_detail_breadcrumbs_ch,
        .w_product_giftset_detail_breadcrumbs_en {
            padding-right: 10px;
            padding-left: 10px;
        }
        ...
        .w_product_giftset_detail_cart_btn:hover a {
        ...
        .w_product_giftset_detail_icon img {
            width: 25%;
        }
        ...
        .w_product_giftset_detail_cook_material {
            width: 130%;
        ...
        .w_product_giftset_detail_cook_material p {
            width: 70%;
        }

        .w_product_giftset_detail_cook_title_line {
            border-bottom: #5C7880 1px solid;
            margin-bottom: 12px;
        }
        ...
        /* ----------以下為大標文字設定---------- */
        .w_product_giftset_detail_title {
            margin: 0 auto;
            text-align: center;
            width: 20%;
        ...
        .w_product_giftset_detail_title_line {
            border-bottom: #5C7880 1px solid;
            padding: 15px 0px;
        }
        ...
        .w_product_giftset_detail_recipe_bg img {
            margin: 70px auto;
            width: 100%;
            height: 600px;
            object-fit: cover;
        ...
        .w_product_giftset_detail_recipe_title {
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
        ...
        .w_product_giftset_detail_recipe_title img {
            width: 35%;
            height: 35%;
        }

        .w_product_giftset_detail_recipe_title_btn {
            padding: 3% 18%;
            margin-top: 20px;
            border-radius: 5px;
            text-align: center;
        ...
        .w_product_giftset_detail_recipe_title_btn a {
            text-decoration: none;
            color: #E67348;
        ...
        .w_product_giftset_detail_star_box_wordin {
            /* 評價區域標題5顆星星 */
            text-align: justify;
        }
        ...
        /* ----------以上為三個icon設定---------- */
            ...
            .w_product_giftset_detail_like_word_box {
                width: 90%;
                text-align: start;
                margin: auto;
            }

            .w_product_giftset_detail_like_word_one {
                width: 100%;
            }

            .w_product_giftset_detail_like_word_two {
                margin-top: 15%;
                width: 100%;
            }

            .w_product_giftset_detail_like_word_two_word {
                margin-top: 15%;
                margin-left: 6%;
                width: 50%;
            }

            .w_product_giftset_detail_like_word_btn {
                margin-left: 10;
                width: 100%;
            }

            .w_product_giftset_detail_like_img_box img {
                margin-top: -150%;
                margin-left: 100%;
            }

            .w_product_giftset_detail_like_img_box_bg {
                position: absolute;
                z-index: 3;
                width: 100%;
                height: 180px;
            ...
            <div class="col-md-7">
                <div class="w_product_giftset_detail_cook_step">
                    ...
                    <p class="noto_thin">
                        ...
                        <br>
                        <br>
                        由雞蛋作成的義大利面，它常見於義大利北部或中部。被製成看起來
                        類似於火炬底部的形狀。 這種形狀很適合舀起以及承受較重的厚實醬
                        汁，與肉或蔬菜一起食用。 適合使用煙花女醬(Puttanesca sauce)
                        加上豌豆和香腸。
                        <br>
                        <br>
                        <?= $product['Description']; ?>
        ...
        <div class="w_product_giftset_detail_wrapper_one">
            ...
            <div class="col-md-3 w_product_giftset_detail_recipe_title">
                ...
                <div class="w_product_giftset_detail_recipe_title_btn">
                    <a class="w_product_giftset_detail_transition" href="">了解更多</a>
                </div>
            </div>
        </div>
        <!------------ 以上為推薦食譜區域 ------------>
