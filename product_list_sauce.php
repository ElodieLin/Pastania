...
<?php include __DIR__. '/__navbar.php' ?>
    <style>
        ...
        .w_product_list_cover {
            width: 100%;
            height: 30vh;
            background: url(img/pages/product_list/sauce_cover.jpg) center 100%;
            ...
            <div class="row">
                <div class="w_product_list_wrapper col-md-4 col-6">
                    ...
                    <div class="w_product_list_word_bg">
                        <!------------ 此處為商品照片連結 （電腦版）------------>
                        <a href="" class="">
                            <p class="w_noto_light_small    w_product_list_word_center    padding-r">義大利麵醬</p>
                            <p class="w_en_font_small    w_product_list_word_center    padding-r">Sauce</p>
                    ...
                    <div class="w_product_list_word_mobil">
                        <!------------ 此處為商品照片連結（手機版） ------------>
                        <a href="">
                            <p class="w_noto_light_small    padding-r">義大利麵醬</p>
                            <p class="w_en_font_small    padding-r">Sauce</p>
                        </a>
                    </div>
                </div>
