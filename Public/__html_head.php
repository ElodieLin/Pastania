...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            var props = [
                '<div class="r_wheel"><div class="r_wheel_warp"><div class="r_wheel_box"><div class="r_wheel_box_in"><p class="en_font r_abs r_wheel_f_n">1</p><h3 class="en_font r_abs r_wheel_f_p">Long Pasta</h3><div class="r_wheel_noodle_box"><img src="img/pages/prelanding/LongPasta.svg" alt="" class="r_abs r_wheel_noodle"></div><a class="en_font r_abs r_wheel_f_g" href="./product_list_long.php">Go</a></div><img src="img/pages/prelanding/pre_page_lid.svg" alt="" class="r_abs r_wheel_lid"><img src="img/pages/prelanding/pre_page_plate.svg" alt="" class="r_abs r_wheel_plate"></div></div></div>',
                '<div class="r_wheel"><div class="r_wheel_warp"><div class="r_wheel_box"><div class="r_wheel_box_in"><p class="en_font r_abs r_wheel_f_n">2</p><h3 class="en_font r_abs r_wheel_f_p">Short Pasta</h3><div class="r_wheel_noodle_box"><img src="img/pages/prelanding/ShortPasta.svg" alt="" class="r_abs r_wheel_noodle"></div><a class="en_font r_abs r_wheel_f_g" href="./product_short_cut.php">Go</a></div><img src="img/pages/prelanding/pre_page_lid.svg" alt="" class="r_abs r_wheel_lid"><img src="img/pages/prelanding/pre_page_plate.svg" alt="" class="r_abs r_wheel_plate"></div></div></div>',
                '<div class="r_wheel"><div class="r_wheel_warp"><div class="r_wheel_box"><div class="r_wheel_box_in"><p class="en_font r_abs r_wheel_f_n">3</p><h3 class="en_font r_abs r_wheel_f_p">Minute Pasta</h3><div class="r_wheel_noodle_box"><img src="img/pages/prelanding/MinutePasta.svg" alt="" class="r_abs r_wheel_noodle"></div><a class="en_font r_abs r_wheel_f_g" href="./product_list_minute.php">Go</a></div><img src="img/pages/prelanding/pre_page_lid.svg" alt="" class="r_abs r_wheel_lid"><img src="img/pages/prelanding/pre_page_plate.svg" alt="" class="r_abs r_wheel_plate"></div></div></div>',
                '<div class="r_wheel"><div class="r_wheel_warp"><div class="r_wheel_box"><div class="r_wheel_box_in"><p class="en_font r_abs r_wheel_f_n">4</p><h3 class="en_font r_abs r_wheel_f_p">Stuffed Pasta</h3><div class="r_wheel_noodle_box"><img src="img/pages/prelanding/StuffedPasta.svg" alt="" class="r_abs r_wheel_noodle"></div><a class="en_font r_abs r_wheel_f_g" href="./product_list_stuffed.php">Go</a></div><img src="img/pages/prelanding/pre_page_lid.svg" alt="" class="r_abs r_wheel_lid"><img src="img/pages/prelanding/pre_page_plate.svg" alt="" class="r_abs r_wheel_plate"></div></div></div>',
                '<div class="r_wheel"><div class="r_wheel_warp"><div class="r_wheel_box"><div class="r_wheel_box_in"><p class="en_font r_abs r_wheel_f_n">5</p><h3 class="en_font r_abs r_wheel_f_p">Speciaity Pasta</h3><div class="r_wheel_noodle_box"><img src="img/pages/prelanding/SpeciaityPasta.svg" alt="" class="r_abs r_wheel_noodle"></div><a class="en_font r_abs r_wheel_f_g" href="./product_list_specialty.php">Go</a></div><img src="img/pages/prelanding/pre_page_lid.svg" alt="" class="r_abs r_wheel_lid"><img src="img/pages/prelanding/pre_page_plate.svg" alt="" class="r_abs r_wheel_plate"></div></div></div>'
            ];
