...
// 取得分類資料
$c_sql = "SELECT * FROM product_list WHERE parent_sid=2";
...
$t_sql = " SELECT COUNT(1) FROM product_info WHERE productlist_sid=2";
...
$p_sql = sprintf("SELECT * FROM product_info WHERE productlist_sid = 2 LIMIT $starting_limit, $per_page");
...
?>
    ...
    <head>
        <link rel="stylesheet" href="css/product_list_minute.css">
    </head>
    ...
    <section>
        ...
        <div class="container">
            <div class="w_product_list_title">
                ...
                <p class="noto_regular">粒狀麵</p>
                <img class="w_product_list_title_img" src="img/pages/product_list/minute_title.svg" alt="">
                <p class="en_font">Minute</p>
