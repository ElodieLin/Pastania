            ...
            <div class="shop">
                ...
                <div class="toogle">
                    ...
                    <ul class=hide2>
                        ...
                        <li>電話：02-8941668</li><br>

                        <li><b>無法退貨的商品和特殊狀況： </b></li>
                        <li>食品類商品依民國105年6月三讀通過《消費者保護法》部分條文修正，除商品本身毀損、破裂、滲漏等情況，其他均</li>
                        <li>恕無法辦理退換貨。 </li>
                    </ul>
                </div>
                <div class="slide_toogle flex">
                ...
                <div class="toogle">
                    ...
                    <ul class="qq">
                        ...
                        <li>Q1：怎麼加入會員？</li>
                        <li> A1：無須加入會員即可購物喔！將商品加入購物車後選擇『第一次購物前往結帳』，即可成立訂單並升級成會員喔！</li>
                    </ul>
                    <ul class="qq">
                        <li>Q2：我想辦理退貨但是我沒有會員？</li>
                        <li>A2 ：交易完成後系統會自動為您升級成會員喔，訂購時填寫的『會員信箱』即會是您會員帳號。</li>
                    </ul>
                    <ul class="qq">
                        <li>Q3：忘記密碼怎麼辦？
                        </li>
                        <li>A3 ：若您忘記密碼，請至 「會員登入」點選「忘記密碼」， 輸入會員帳號及驗證碼，系統即會自動將重製的新密碼寄至您Email信箱提供您登入使用。</li>
                    </ul>
                    <h4 class="si">配送</h4>
                    <ul class="qq">
                        <li>Q1：包裹何時會出貨呢？</li>
                        <li> A1 ：每天14:00前的訂單會安排當天出貨，宅配大概1-2天送到(週日不配送)，超商大概2-3天；海外包裹為平日下午時段安排寄出，攬件寄出後配送時間約為5~7個工作天。
                        </li>
                    </ul>
                    <ul class="qq">
                        <li>Q2：可以查詢包裹編號追蹤嗎？</li>
                        <li>A2 ：請您由官網會員登入－訂單查詢－點選該筆訂單輸入您的訂單號碼與認證碼以查詢訂單狀況，如果對訂單狀況有疑問，請與我們聯絡。 </li>
                    </ul>
                    <ul class="qq">
                        <li>Q3：忘記密碼怎麼辦？
                        </li>
                    ...
                    <ul class="qq">
                        ...
                        <li> A1 ：訂單成立後系統會送通知信件至您留下的會員信箱，也可於官網－會員登入－訂單查詢內查看喔！
                        </li>
                    </ul>
                    <ul class="qq">
                        <li>Q2：刷卡訂單不確定有沒有付款成功？</li>
                        <li>A2 ：刷卡付款訂單成立後會進入銀行對帳排程作業(約一小時)，可於稍晚自行由官網－登入會員－訂單查詢查看訂單狀態，
                            若顯示交易失敗即表示付款不成功，將不會進行扣款及出貨安排，如有需要還請您重新訂購！</li>
                    </ul>
                    <ul class="qq">
                        <li>Q3：訂單成立後可以修改訂購內容嗎？ </li>
                        <li>A3 ：成立訂單後恕無法為您修改商品明細、拆併訂單、改付款及配送方式之服務，避免延誤出貨的狀況噢！</li>
                    </ul>
                    <ul class="qq">
                        <li>Q4：信用卡交易失敗怎麼辦？ </li>
                        <li>A4 ：訂單因交易失敗導致訂單未成立成功，交易失敗的訂單無法再恢復訂單狀態重新付款。若您還需要此訂單內商品，請您重新訂購。</li>
                    </ul>
                    <h4 class="si">退換貨</h4>
                    <ul class="qq">
                        <li>Q1：如何申請退換貨？ </li>
                        <li> A1 ：退換貨可於上班時間與我們聯繫，將有專人為您服務。 </li>
                    </ul>
                    <h4 class="si">售後</h4>
                    <ul class="qq">
                        <li>Q1：若收到異常商品怎麼辦？ </li>
                        <li> A1 ：若商品有異常疑慮，請您提供商品實際照片至客服信箱(service@pastania.com.tw)或是粉絲團私訊，並且附上您
                            的手機號碼/訂單編號/會員帳號，待收到後將會盡快請相關部門確認並且回覆。 </li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="toogle">
                    <ul>
                        ...
                        <li> 本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本
                            網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</li><br>
